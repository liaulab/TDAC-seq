...
if(genome == "mm10"){
  blacklist <- "/home/yanhu/data/DddA/shared/BlacklistFiles/mm10.full.blacklist.bed"
  chrSizes <- "/home/yanhu/data/DddA/shared/mm10.chrom.sizes"
}else if(genome == "hg19"){
  blacklist <- "/home/yanhu/data/DddA/shared/BlacklistFiles/hg19.full.blacklist.bed"
  chrSizes <- "/home/yanhu/data/DddA/shared/hg19.chrom.sizes"
}else if(genome == "hg38"){
  blacklist <- "/home/yanhu/data/DddA/shared/BlacklistFiles/hg38-blacklist.v2.bed"
  chrSizes <- "/home/yanhu/data/DddA/shared/hg38.chrom.sizes"
}
